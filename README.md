...
| :---------------------------------------------------------------: | :------------------------------------------------------------: |
| <img src="asset/images/gif/splash.gif" width="230" height="400"/> | <img src="src/assets/gif/login.gif" width="230" height="400"/> |
...
-   협업 방식으로 Git Flow 전략을 사용하여 소스코드를 관리하여 기존의 5가지 브랜치로 나누지 않고 필요하다고 생각되는 3가지 브랜치(main, develop, feature)로 줄여서 적용하였다.
